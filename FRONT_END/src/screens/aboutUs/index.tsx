    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8 m-5 md:m-20">
        ...
        <div className="md:col-span-1 mt-5 md:mt-7">
          <a
            href="#our-story"
            className="block text-textSecondary text-sm hover:text-textPrimary transition"
          >
            OUR STORY
          </a>
          <a
        ...
        <div className="md:col-span-4">
          ...
          >
            Founded by a team of passionate professionals who understand the
            challenges of the job market, our mission is to simplify the
            recruitment process. We believe that every individual has unique
            skills and potential, and every company has a unique culture and
            vision. By leveraging cutting-edge technology and a deep
            understanding of the industry, we aim to match the right talent with
            the right opportunities.
            <br />
            <br />
            Join us on this journey and take the first step towards your dream
            career or finding the perfect candidate for your team. Together, we
            can build a future where everyone thrive.
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-center m-5 md:m-20" id="vision">
        ...
        >
          "Empowering careers, connecting talent with opportunity, and building
          futures together."
        </p>
      </div>
          ...
          <div className="mt-5 md:mt-8">
            <div id="mission">
              ...
              >
                ...
                outstanding opportunities, fostering a community where both
                employers and job seekers thrive. We are committed to creating a
                transparent, inclusive, and empowering recruitment process that
                not only matches skills with roles but also aligns values and
                aspirations.
                <br />
                <br />
                By nurturing meaningful connections, we aim to build a future
                where everyone can achieve their career dreams and contribute to
                a better world.
              </p>
            </div>
          </div>
