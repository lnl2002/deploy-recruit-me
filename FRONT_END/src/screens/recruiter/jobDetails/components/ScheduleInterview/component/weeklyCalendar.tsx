    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex ml-20 border-b">
        {timelineHours?.map((hour) => (
          <div key={hour} className="flex-1 text-xs text-textSecondary text-center">
                  ...
                  >
                    {event.timeStart && (
                      <div className="flex items-center gap-2">
                        <p className="text-textPrimary">{`Meeting at ${format(event.timeStart, "HH:mm a")}`}</p>
                      </div>
                    )}
                  </button>
                ))}
