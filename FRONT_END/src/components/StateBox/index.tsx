...
export const StateBox: React.FC<Props> = (props) => {
    ...
    const conFirmMeeting = () => {
        ...
        if (meeting && applyInfo?.status.name === "Pending Interview Confirmation")
            return (
                <>
                    {
                        meeting.participants.filter((e) => e.participant == userInfo?._id).at(0)?.status &&
    ...
    return (
        <div>
            ...
            {
                meeting && <div className="flex flex-col gap-4 mt-10">
                    <div className="flex gap-4">
                        <div className="bg-surfaceTertiary p-3 rounded-full">
                            <AlarmClockIcon color="#000000" />
                        </div>
                        <div>
                            <p className="text-textPrimary text-lg font-semibold">{formatDateTimeSeperate(meeting?.timeStart ?? "").time}</p>
            ...
            <ModalCommon size={"xl"} disclosure={declineDisclosure}>
                <Card className=" w-full  bg-white shadow-none">
                    <CardHeader className="flex flex-col items-center justify-center gap-2 pt-6">
                        <h1 className="text-xl font-semibold">Decline Interview Schedule</h1>
                        <p className="text-sm text-textTertiary text-center">
                            To assist us in scheduling future interviews, please provide a reason for declining
                            and suggest alternative times that would be more convenient.
                        </p>
                    </CardHeader>
                    ...
                    <CardFooter className="flex flex-col gap-3">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span className="text-textTertiary">
                                Kindly note that 3 declines may impact your future interview opportunities.
                            </span>
                        </div>
                    </CardFooter>
                </Card>
            ...
            <ModalCommon size={"xl"} disclosure={agreeDisclosure}>
                <Card className=" w-full  bg-white shadow-none">
                    <CardHeader className="flex flex-col items-center justify-center gap-2 pt-6">
                        ...
                        <p className="text-sm text-textTertiary text-center">
                            By accepting the schedule, you will be recorded as having agreed with the time and ready for the meeting.
                        </p>
                    </CardHeader>
